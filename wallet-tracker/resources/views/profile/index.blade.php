																				...
																				<div class="card car-transparent">
																								<div class="card-body p-0">
																												<div class="profile-image position-relative">
																																<img src="{{ asset('images/page-img/profile.png') }}" class="img-fluid rounded w-100"
																																				alt="profile-image">
																												</div>
																								</div>
																				</div>
																								...
																								<div class="card-body">
																												<div class="d-flex align-items-center mb-3">
																																<div class="profile-img position-relative">
																																				<img src="{{ asset('images/user/1.png') }}" class="img-fluid rounded avatar-110"
																																								alt="profile-image">
																																</div>
																																<div class="ml-3">
																																				<h4 class="mb-1">{{ $user->name }}</h4>
																																				<p class="mb-2">
																																								{{ $user->interest ? $user->interest : 'Edit profile to display your interest' }}
																																				</p>
																																				<a href="{{ route('profile.edit') }}" class="btn btn-primary font-size-14">Edit
																																								Profile</a>
																																</div>
																												</div>
																												<p>
																																{{ $user->about ? $user->about : 'Edit profile to display your short story' }}
																												</p>
																												<ul class="list-inline p-0 m-0">
																																...
																																<li class="mb-2">
																																				<div class="d-flex align-items-center">
																																								...
																																								<p class="mb-0">{{ $user->phone_number ? $user->phone_number : 'Unavailable' }}
																																								</p>
																																				</div>
																																</li>
																																<li>
																																				<div class="d-flex align-items-center">
																																								...
																																								<p class="mb-0">{{ $user->email ? $user->email : 'Unavailable' }}</p>
																																				</div>
																																</li>
																												</ul>
																								</div>
																								...
																								<div class="card-body">
																												<ul class="d-flex nav nav-pills mb-3 text-center profile-tab" id="profile-pills-tab"
																																...
																																<li class="nav-item">
																																				<a class="nav-link active show" data-toggle="pill" href="#profile1" role="tab"
																																								aria-selected="false">My Skills</a>
																																</li>
																																<li class="nav-item">
																												...
																												<div class="profile-content tab-content">
																																<div id="profile1" class="tab-pane fade active show">
																																				<p>
																																								Lorem ipsum dolor sit amet, consectetur adipiscing elit. Turpis viverra viverra
																																								mollis sed vitae fames
																																								nunc sollicitudin viverra. Curabitur massa, ultrices diam ipsum faucibus risus.
																																								Hendrerit justo,
																																								quis massa a elementum. At elementum.
																																				</p>
																																				<div class="row">
																																								<div class="col-lg-6">
																																												<ul class="list-inline p-0 m-0">
																																																<li class="mb-4">
																																																				<div class="d-flex align-items-center pt-2">
																																																								<img src="{{ asset('images/profile/service/01.png') }}"
																																																...
																																																<li class="mb-4">
																																																				<div class="d-flex align-items-center pt-2">
																																																								<img src="{{ asset('images/profile/service/02.png') }}"
																																																...
																																																<li>
																																																				<div class="d-flex align-items-center pt-2">
																																																								<img src="{{ asset('images/profile/service/03.png') }}"
																																																												class="img-fluid" alt="image">
																																																								<div class="ml-3 w-100">
																																																												<div class="media align-items-center justify-content-between">
																																																																<p class="mb-0">Adobe Photoshop</p>
																																								...
																																								<div class="col-lg-6">
																																												<ul class="list-inline p-0 m-0">
																																																<li class="mb-4">
																																																				<div class="d-flex align-items-center pt-2">
																																																								<img src="{{ 'images/profile/service/04.png' }}"
																																																												class="img-fluid" alt="image">
																																																								<div class="ml-3 w-100">
																																																												<div class="media align-items-center justify-content-between">
																																																																<p class="mb-0">Adobe Photoshop</p>
																																																...
																																																<li class="mb-4">
																																																				<div class="d-flex align-items-center pt-2">
																																																								<img src="{{ asset('images/profile/service/05.png') }}"
																																																												class="img-fluid" alt="image">
																																																								<div class="ml-3 w-100">
																																																												<div class="media align-items-center justify-content-between">
																																																																<p class="mb-0">Figma</p>
																																																...
																																																<li>
																																																				<div class="d-flex align-items-center pt-2">
																																																								<img src="{{ asset('images/profile/service/06.png') }}"
																																																												class="img-fluid" alt="image">
																																																								<div class="ml-3 w-100">
																																																												<div class="media align-items-center justify-content-between">
																																																																<p class="mb-0">Adobe Photoshop</p>
																																																								...
																																																								<div class="card-body p-3">
																																																												<ul class="list-inline p-0 m-0">
																																																																<li class="mb-2 d-flex">
																																																																				<span>
																																																																								<i
																																																																												class="lab la-facebook-f icon-text-primary font-size-20 mr-3"></i>
																																																																				</span>
																																																																...
																																																																<li class="mb-2 d-flex">
																																																																				<span>
																																																																								<i
																																																																												class="lab la-twitter icon-text-info font-size-20 mr-3"></i>
																																																																				</span>
																																																																...
																																																																<li class=" d-flex">
																																																																				<span>
																																																																								<i
																																																																												class="lab la-instagram  icon-text-danger font-size-20 mr-3"></i>
																																																																				</span>
																																																				...
																																																				<div class="col-md-9">
																																																								<div class="media profile-media align-items-top">
																																																												...
																																																												<div class="ml-4">
																																																																...
																																																																<p class="mb-0 font-size-14">South Kellergrove University
																																																																</p>
																																																												</div>
																																																								</div>
																																																				</div>
																																																...
																																																<div class="row align-items-top">
																																																				...
																																																				<div class="col-md-9">
																																																								<div class="media profile-media align-items-top">
																																																												<div class="profile-dots border-primary mt-1"></div>
																																																												<div class="ml-4">
																																																																<h6 class=" mb-1">Master of Science in Computer Science
																																																																</h6>
																																																...
																																																<div class="row align-items-top">
																																																				...
																																																				<div class="col-md-9">
																																																								<div class="media profile-media align-items-top">
																																																												<div class="profile-dots border-primary mt-1"></div>
																																																												<div class="ml-4">
																																																																<h6 class=" mb-1">Bachelor of Science in Computer Science
																																																																</h6>
																																...
																																<div id="profile5" class="tab-pane fade">
																																				<p>
																																								I'm Web Developer from California. I code and design websites worldwide. Mauris
																																								variustellus vitae
																																				...
																																				<p>
																																								Lorem ipsum dolor sit amet, consectetur adipiscing elit. Iaculis mattis nam ipsum
																																								...
																																								fermentum tempus
																																								uspendisse ultricies. Tellus sapien, convallis proin pretium.
																																				</p>
																																				<p class="mb-0">
																																								Lorem ipsum dolor sit amet, consectetur adipiscing elit. Iaculis mattis nam ipsum
																																								pharetra porttitor eu.
